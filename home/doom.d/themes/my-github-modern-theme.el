...
(deftheme my-github-modern "The GitHub color theme")
...
;;;;; basic coloring
   ...
   ;; NOTE
   `(success ((t (:foreground ,github-note :weight bold))))
   ;; TODO
   `(warning ((t (:foreground ,github-todo :weight bold))))
...
;;;;; git-gutter-fr
   `(git-gutter-fr:added ((t (:foreground ,github-diff-added-highlight  :weight bold))))
   `(git-gutter-fr:deleted ((t (:foreground ,github-diff-removed-highlight :weight bold))))
   `(git-gutter-fr:modified ((t (:foreground ,github-diff-changed-highlight :weight bold))))
;;;;; git-rebase
...
;;;;; org-mode
   ...
   `(org-link ((t (:foreground ,github-function :underline t))))
...
(provide-theme 'my-github-modern)
